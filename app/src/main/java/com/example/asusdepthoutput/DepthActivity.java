...
public class DepthActivity extends Activity {
	...
	private PermissionCallbacks m_callbacks = new PermissionCallbacks() {
		...
		{ 
			try 
			{
				...
				m_dd.setMapOutputMode(320, 240, 30);//�������ͼ��ֱ���
			} catch (Exception e) 
			{
				e.printStackTrace();
			} 
			...
			layout.addView(new XtionView(DepthActivity.this));
	...
	public class XtionView extends SurfaceView implements Callback, Runnable {
		...
		int depth_value = 0;//ʵ�����ֵ
		int grey_value = 0;//ʵ�ʻҶ�ֵ
		@Override
		public void run() {
